...
<span class="badge-travisci"><a href="http://travis-ci.org/bevry/progress-title" title="Check this project's build status on TravisCI"><img src="https://img.shields.io/travis/bevry/progress-title/master.svg" alt="Travis CI Build Status" /></a></span>
...
<span class="badge-thanksapp"><a href="https://givethanks.app/donate/npm/progress-title" title="Donate to this project using Thanks App"><img src="https://img.shields.io/badge/thanksapp-donate-yellow.svg" alt="Thanks App donate button" /></a></span>
<span class="badge-boostlab"><a href="https://boost-lab.app/bevry/progress-title" title="Donate to this project using Boost Lab"><img src="https://img.shields.io/badge/boostlab-donate-yellow.svg" alt="Boost Lab donate button" /></a></span>
...
<li>Require: <code>require('progress-title')</code></li>
</ul>
...
<ul><li><code>progress-title</code> aliases <code>progress-title/index.js</code> which uses <a href="https://editions.bevry.me" title="Editions are the best way to produce and consume packages you care about.">Editions</a> to automatically select the correct edition for the consumers environment</li>
<li><code>progress-title/source/index.js</code> is esnext source code with require for modules</li>
<li><code>progress-title/edition-node-4/index.js</code> is esnext compiled for node.js 4 with require for modules</li></ul>
...
[API Documentation.](http://master.progress-title.bevry.surge.sh/docs/)
...
<ul><li><a href="http://balupton.com">Benjamin Lupton</a> — <a href="https://github.com/bevry/progress-title/commits?author=balupton" title="View the GitHub contributions of Benjamin Lupton on repository bevry/progress-title">view contributions</a></li></ul>
